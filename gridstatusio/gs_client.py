...
class GridStatusClient:
    ...
    def get_dataset(
        ...
        Parameters:
            ...
            publish_start (str): The start time of the data to fetch based on the
            dataset's publish_time_column.

            publish_end (str): The end time of the data to fetch based on the
            dataset's publish_time_column.
        ...
        if publish_start is not None:
            publish_start = utils.handle_date(publish_start, tz)

        if publish_end is not None:
            publish_end = utils.handle_date(publish_end, tz)
